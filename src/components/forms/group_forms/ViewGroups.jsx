...
import SubjectResultsListForRead from "./SubjectResultsListForRead";
    ...
    <div>
      ...
      {subjects.length > 0 && (
        <div>
          ...
          <SubjectResultsListForRead subjects={subjects} />
        </div>
      )}
        ...
        <div>
          ...
          {Object.keys(sessionsByGroupNumber).map((groupNum) => (
            <div key={groupNum} style={{ marginBottom: "2rem" }}>
              ...
              <ScheduleTable
                sessions={sessionsByGroupNumber[groupNum]}
                teacherColor="#ffffff"
              />
            </div>
          ))}
